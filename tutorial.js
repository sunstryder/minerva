...
//set the constants SLACK_TOKEN etc by typing export SLACK_TOKEN=[token_here]
//instantiate the webclient object with the slack token provided to the process.env
